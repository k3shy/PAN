      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {content.collections.map((collection) => (
            <div
              key={collection.id}
              className="group relative overflow-hidden rounded-sm bg-gradient-to-br from-pan-accent/20 to-pan-dark border border-white/5 hover:border-pan-accent/30 transition-all duration-500 cursor-pointer"
            >
