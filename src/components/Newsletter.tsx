...
export default function Newsletter() {
  ...
  return (
    <section className="py-20 md:py-32 bg-pan-dark relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-pan-accent/5 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-pan-accent/5 rounded-full blur-3xl"></div>
